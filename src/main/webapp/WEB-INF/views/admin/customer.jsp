...
<body>
	<div class="container" style="text-align: center">
		<h2 style="font-size: 40pt; margin-top: 50px">Customer</h2>

		<!-- Trigger the modal with a button -->
		<button style="float: right" type="button"
			class="btn btn-info btn-lg btn-add" data-toggle="modal"
			data-target="#myModalAddProduct">Add Customer</button>
		...
		<table class="table table-bordered table-striped">
			...
			<tbody id="myTable">
				<c:forEach var="product" items="${listCustomer}">
					<tr>
						...
						<td>
							<button style="margin-right: 20px" type="button"
								...
								data-target="#myModalEditProduct">Edit Customer</button>
							...
							<input type="hidden" id="nameCustomer" value="${customer.username}">
							 
							<!-- <input type="hidden" id="descriptionCustomer"
							value="${customer.description}"> <input type="hidden"
			...
			<div class="modal-content">
				<form id="formDelete" action="" method="get">
					<div class="modal-header">
						...
						<h4 class="modal-title">Detele Customer</h4>
					</div>
