	...
	function seeMoreProducts() {
	    $.ajax({
	        ...
	        success: function(data) {
	            ...
	            let htmlRes = ""; // Khởi tạo giá trị rỗng cho biến htmlRes
	            for (var i = 0; i < dataRes.length; i++) {
	                htmlRes += "<li class='span4'>" +
	                    "<div class='thumbnail'>" +
	                    "<a class='zoomTool' href='/BookShop/chi-tiet-san-pham/" + dataRes[i].bookId + "' title='add to cart' style='display: none;'><span class='icon-search'> QUICK VIEW</span></a>" +
	                    "<a href='/BookShop/chi-tiet-san-pham/" + dataRes[i].bookId + "'><img src='/BookShop/assets/user/img/" + dataRes[i].img + "' alt=''></a>" +
	                    "<div class='caption'>" +
	                    ...
	                    "<a class='shopBtn' href='/BookShop/AddCart/" + dataRes[i].bookId + "' title='add to cart'><span class='icon-plus'></span></a>" +
	                    "<span class='pull-right'>" + dataRes[i].price + " ₫</span>" +
	                    "</h4>" +
	                    "</div>" +
	                    "</div>" +
	                    "</li>";
